package io.github.tomasborsje.slugcraft.models;// Made with Blockbench 4.9.2
...
public class NeedleModel extends Model {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(SlugCraft.MODID, "needlemodel"), "main");
